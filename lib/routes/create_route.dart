...
class _CreateRouteState extends State<CreateRoute> {
  ...
  @override
  void initState() {
    if (server==null) server = new Server(languages: [], comments: [], instances: [], tags: [], rules: [], autogenerated: false, visible: false);
    super.initState();
  }
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: MarkdownEditor(width: (size.width * 0.75) - 16, callback: (s) => server.description = s,),
                ),
                Container(height: 64,),
